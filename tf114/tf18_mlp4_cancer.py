...
w1 = tf.compat.v1.Variable(tf.zeros([30,50]), name='weight')   
b1 = tf.compat.v1.Variable(tf.zeros([50]), name='bias')   
...
w3 = tf.compat.v1.Variable(tf.random.uniform([10,10]), name='weight3')
b3 = tf.compat.v1.Variable(tf.random.uniform([10]), name='bias3')

Hidden_layer3 = tf.matmul(Hidden_layer2, w3)+b3

w4 = tf.compat.v1.Variable(tf.zeros([10,1]), name='weight4')
