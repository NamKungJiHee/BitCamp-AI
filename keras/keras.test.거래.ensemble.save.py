...
def split_xy5(dataset, time_steps, y_column):  # n , 4 , 2
    x,y = list(), list()  # x와 y에 담겠다.
    
    for i in range(len(dataset)):
        x_end_number= i + time_steps    # 몇개(며칠치)로 나누어 줄것인가 4
        y_end_number = x_end_number + y_column    # y값 의미(위치)  6
...
x1, y1 = split_xy5(s1,4,2)
x2, y2 = split_xy5(k1,4,2)
...
dense01 = LSTM(5, activation = 'relu', name = 'dense01')(input2)
