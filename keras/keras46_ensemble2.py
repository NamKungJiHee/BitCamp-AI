...
model.fit([x1_train,x2_train], [y1_train,y2_train], epochs = 1000, validation_split=0.2, callbacks=[es], batch_size = 50)
...
"""
[47.75291442871094, 46.47978591918945, 1.273128867149353, 4.505442142486572, 0.935327410697937] 
  전체 loss                y1 loss          y2 loss           mae1             mae2
"""
