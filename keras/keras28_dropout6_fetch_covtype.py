...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto',verbose=1, save_best_only=True, filepath = './_ModelCheckPoint/keras28_6_MCP.hdf5') 


model.fit(x_train, y_train, epochs = 10000, batch_size=500, validation_split= 0.2,callbacks=[es,mcp])  

model.save("./_save/keras_028.6_fetch_covtype_save_model.h5")
...
model2 = load_model('./_save/keras_028.6_fetch_covtype_save_model.h5')  
...
============================1. 기본 출력=======================
3632/3632 [==============================] - 1s 405us/step - loss: 0.5696 - accuracy: 0.7573
loss:  [0.5696486830711365, 0.7573126554489136]
r2스코어 :  0.39662789484339533
============================2. load_model 출력=======================
3632/3632 [==============================] - 2s 399us/step - loss: 0.5696 - accuracy: 0.7573
loss2:  [0.5696486830711365, 0.7573126554489136]
r2스코어 :  0.39662789484339533
============================3. ModelCheckPoint 출력=======================
3632/3632 [==============================] - 2s 399us/step - loss: 0.5696 - accuracy: 0.7573
loss3:  [0.5696486830711365, 0.7573126554489136]
r2스코어 :  0.39662789484339533
