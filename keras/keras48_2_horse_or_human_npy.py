...
x_train = np.load('../_data/_save_npy/keras48_2_train_x.npy')
y_train = np.load('../_data/_save_npy/keras48_2_train_y.npy')
x_test = np.load('../_data/_save_npy/keras48_2_test_x.npy')
y_test = np.load('../_data/_save_npy/keras48_2_test_y.npy')
