...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto',verbose=1, save_best_only=False, filepath = './_ModelCheckPoint/keras27_5_MCP.hdf5') 


model.fit(x_train, y_train, epochs=10000, batch_size=5, validation_split=0.25, callbacks=[es,mcp]) 
#model.save("./_save/keras_05.1_wine_save_model.h5")

model = load_model("./_save/keras_05.1_wine_save_model.h5")
...
model2 = load_model('./_save/keras_05.1_wine_save_model.h5')  
