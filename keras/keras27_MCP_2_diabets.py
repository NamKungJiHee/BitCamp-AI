...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto',verbose=1, save_best_only=True, filepath = './_ModelCheckPoint/keras27_2_MCP.hdf5') 

model.fit(x_train, y_train, epochs=10000, batch_size=5, validation_split=0.11111111, callbacks=[es,mcp])
model.save("./_save/keras_02.1_diabets_save_model.h5")
...
model2 = load_model('./_save/keras_02.1_diabets_save_model.h5')  
