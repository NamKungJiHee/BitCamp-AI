...
#model.summary()
'''
Model: "sequential"  ############ model.add(Embedding(input_dim = 27, output_dim= 10, input_length=5))로 썼을 때  ################
_________________________________________________________________
 Layer (type)                Output Shape              Param #
=================================================================
 embedding (Embedding)       (None, 5, 10)             280                 (13, 5, 28) -> 1820  //  28(input_dim)*10(output_dim) = 280
...
####################################  model.add(Embedding(28,10)) 로 썼을 때##########################################
Model: "sequential" 
_________________________________________________________________
 Layer (type)                Output Shape              Param #
=================================================================
