...
mcp = ModelCheckpoint(monitor='val_loss', mode='auto',verbose=1, save_best_only=True, filepath = './_ModelCheckPoint/keras27_7_MCP.hdf5') 



model.fit(x_train, y_train, epochs=10000, validation_split=0.2,callbacks=[es,mcp]) 

model.save("./_save/keras_07.1_kaggle_bike_save_model.h5")
...
model2 = load_model('./_save/keras_07.1_kaggle_bike_save_model.h5')  
