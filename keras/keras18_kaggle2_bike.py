...
#loss:  1.448859453201294
#r2:  0.26061793730829397
#RMSE:  1.2036857608330596


#loss:  23747.056640625
#r2:  0.2486946039542226
#RMSE:  154.10080904819506
###================================================== 제출용
...
'''
              datetime     count
0  2011-01-20 00:00:00  3.971792
1  2011-01-20 01:00:00  3.521793
2  2011-01-20 02:00:00  3.521793
3  2011-01-20 03:00:00  3.723572
4  2011-01-20 04:00:00  3.723572
5  2011-01-20 05:00:00  3.620274
6  2011-01-20 06:00:00  3.577310
7  2011-01-20 07:00:00  3.711124
8  2011-01-20 08:00:00  3.799712
9  2011-01-20 09:00:00  3.959102
'''

# numpy = 숫자들의 모임
# pandas = pandas는 object, string 등 모든 것을 담아놓을 수 있음!
# 데이터 값들이 클 경우 부동소수점...으로 바꿔준당
# if 데이터값이 최소1 ~ 최대 100만이라면 최대값을 최대 1로 change
# MINMAX Scaler를 할 때 특성이 여러개라면 특성 각각 소수점으로 바꿔준당
