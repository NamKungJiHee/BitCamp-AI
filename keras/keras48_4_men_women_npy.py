...
# np.save('./_save_npy/keras48_4_test_x.npy', arr = xy_test[0][0])
# np.save('./_save_npy/keras48_4_test_y.npy', arr = xy_test[0][1])
...
# print(x_train.shape)  # (3, 100, 100, 3)
# print(y_train.shape)  # (3,)
# print(x_test.shape)  # (3, 100, 100, 3)
