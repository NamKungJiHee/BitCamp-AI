...
#model.load_weights('./_save/keras25_1_save_weights.h5')     # loss:  67183.875
...
#model.load_weights("./_save/keras25_3_save_weights.h5")    #compile전에 해도 이미 weights값이 들어가므로 값나오는건 상관없음!
...
#model.load_weights('./_save/keras25_1_save_weights.h5')    # x
model.load_weights("./_save/keras25_3_save_weights.h5")     #loss:  22.783187866210938
                                                            #r2스코어 :  0.7274182161087579
                                                            # load_weights는 앞에 compile을 해줘야한당!
