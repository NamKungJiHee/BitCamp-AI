...
print(xy_train[0][0].shape, xy_train[0][1].shape)  # x = (13, 100, 100, 3) (13,)
...
hist = model.fit_generator(xy_train, epochs= 200, steps_per_epoch= 79, validation_data= xy_test,
...
'''
loss:  0.07614143937826157
val_loss:  0.0
acc:  0.922103226184845
val_acc:  1.0
