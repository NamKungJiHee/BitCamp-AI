...
model.fit(x_train, y_train, verbose = 1,
          eval_set = [(x_test, y_test)],   # eval_set: 평가를 x,ytest로 할거다.  
                    eval_metric= 'logloss',)  # rmse, mae, logloss, error, merror, mlogloss
end = time.time()
...
''' 
[1997]  validation_0-logloss:0.10389
[1998]  validation_0-logloss:0.10389  
[1999]  validation_0-logloss:0.10389       logloss : 이진분류
걸린시간:  1.6436395645141602      
results:  0.9825     
r2:  0.9825
'''