...
"""
[19519.826171875, 17924.837890625, 91.33583068847656, 1503.651611328125, 117.31504821777344, 8.295029640197754, 34.068077087402344]

"""
y_predict = np.array(model.predict(x1_test))
# print(y_predict.shape)   # (3, 30, 1)
y_predict = y_predict.reshape(3,30)
# print(y_predict.shape)   # (3,30)
